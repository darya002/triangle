// OpenGlTexture.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	unsigned char* data2 = stbi_load("texture/texture1.jpg", &width2, &height2, &nrChannels2, 0);
	if (data2)
	{
